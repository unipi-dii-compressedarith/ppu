...
tb = [
    ...
    (
        decode(0b01110010000000000000000000011111, 32, 2).to_real(),
        512.0004730224609
    ),
    (
    ...
    (
        decode(0b01111111111111111111111111110011,32,2).to_real(), 
    ...
    (
        decode(0b01111111111111111111111111111101,32,2).to_real(),
    ...
    (
        decode(0b01111111111111111111111111111011,32,2).to_real(),
    ...
    (
        decode(0b01111111111111111111111111111111,32,2).to_real(),
