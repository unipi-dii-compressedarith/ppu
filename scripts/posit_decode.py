...
tb = [
    ...
    (
        decode(0b01110010000000000000000000011111, 32, 2).color_code(),
    ...
    (
        decode(0b01111111111111111111111111110011, 32, 2).color_code(),
    ...
    (
        decode(0b01111111111111111111111111111101, 32, 2).color_code(),
    ...
    (
        decode(0b01111111111111111111111111111011, 32, 2).color_code(),
    ...
    (
        ...
        "\x1b[1;37;41m0\x1b[1;30;43m1111111111111111111111111111111\x1b[1;37;44m\x1b[1;37;40m\x1b[0m",  # fails until you fix reg len
    ),
    (decode(0b0111111111111111, 16, 1).to_real(), 268435456.0),
    (
        decode(0b0111111111111111, 16, 1).color_code(),
        "\x1b[1;37;41m0\x1b[1;30;43m111111111111111\x1b[1;37;44m\x1b[1;37;40m\x1b[0m",  # fails regime
    ),
    (decode(0b0111111111111110, 16, 1).to_real(), 67108864.0),
    (
        decode(0b0111111111111110, 16, 1).color_code(),
        "\x1b[1;37;41m0\x1b[1;30;43m111111111111110\x1b[1;37;44m\x1b[1;37;40m\x1b[0m",
    ),
    (
    ...
    (
        decode(0b10001111011111010010001111010111, 32, 2).color_code(),
    ...
    (
        decode(0b10000000000000000000000000000011, 32, 2).color_code(),
        "\x1b[1;37;41m1\x1b[1;30;43m111111111111111111111111111110\x1b[1;37;44m0\x1b[1;37;40m\x1b[0m",
    ),
    (
